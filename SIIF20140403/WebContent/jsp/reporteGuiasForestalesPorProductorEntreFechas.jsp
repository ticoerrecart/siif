...
function generarReporte(){
	...
	if(volumen != "-1" && productor != "-1" && fechaDesde != "" && fechaHasta != ""){
		...
		if(type == "IE"){
			window.open("./reporte.do?metodo=generarReporteGuiasForestalesPorProductorEntreFechas&productor="+productor+"&fechaDesde="+fechaDesde+"&fechaHasta="+fechaHasta,"",especificaciones);
		}else{
			window.open("../../reporte.do?metodo=generarReporteGuiasForestalesPorProductorEntreFechas&productor="+productor+"&fechaDesde="+fechaDesde+"&fechaHasta="+fechaHasta,"",especificaciones);
		}
	}
		...
		$("#error").html(textoError2 + textoError3 + textoError4);		
	}
}
...
<table border="0" class="cuadrado" align="center" width="70%" cellpadding="2">
	<tr>
		<td class="azulAjustado">
			Guías Forestales Por Productor Entre Fechas
		</td>
	</tr>
	<tr>
		<td height="20"></td>
