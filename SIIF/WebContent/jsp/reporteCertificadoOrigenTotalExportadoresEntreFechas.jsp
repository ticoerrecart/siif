...
function generarReporte(){
	...
	if(fechaDesde != "" && fechaHasta != ""){
		...
		if(type == "IE"){
			window.open("./reportesCertificadoOrigen.do?metodo="+metodo+"&fechaDesde="+fechaDesde+"&fechaHasta="+fechaHasta,"",especificaciones);
		}else{
			window.open("../../reportesCertificadoOrigen.do?metodo="+metodo+"&fechaDesde="+fechaDesde+"&fechaHasta="+fechaHasta,"",especificaciones);
		}
	}
...
<table border="0" class="cuadrado" align="center" width="70%" cellpadding="2">
	<tr>
		<td class="azulAjustado">
			Certificados de Origen - Total de Exportadores Entre Fechas
		</td>
	</tr>
	<tr>
		<td height="20"></td>
