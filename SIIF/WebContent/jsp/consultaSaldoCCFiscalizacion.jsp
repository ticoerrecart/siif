...
<table border="0" class="cuadrado" align="center" width="50%" id="idProductores"
	cellpadding="2">
	<tr>
		<td colspan="2" class="azulAjustado">Consulta Saldo por Compensación de Fiscalizaciones</td>
	</tr>
	<tr>
	...
	<c:forEach items="${productores}" var="entidad">
		<tr>
			<td align="left"><c:out value="${entidad.nombre}"></c:out></td>
				<c:if test="${entidad.saldoCCFiscalizacion ge 0 }">			
						<td class="verdeExito" style="text-align: right;" >
							${entidad.saldoCCFiscalizacion}
						</td>
					</c:if>
					<c:if test="${entidad.saldoCCFiscalizacion lt 0 }">			
