...
<div id="exitoGrabado" class="verdeExito">${exitoGrabado}</div>
	...
	<table border="0" class="cuadrado" align="center" width="60%" cellpadding="2">
		...
		<tr>
			<td width="40%" class="botoneralNegritaRight"><bean:message key='SIIF.label.ProvinciaDestino'/></td>
			<td align="left">
		...
		<tr>
			<td width="40%" class="botoneralNegritaRight"><bean:message key='SIIF.label.LocalidadDestino'/></td>
			<td align="left">
