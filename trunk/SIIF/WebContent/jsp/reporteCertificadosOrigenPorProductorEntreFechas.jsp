...
function generarReporte(){
	...
	if(productor != "-1" && fechaDesde != "" && fechaHasta != ""){
		...
		if(type == "IE"){
			window.open("./reportesCertificadoOrigen.do?metodo=generarReporteCertificadosOrigenPorProductorEntreFechas&productor="+productor+"&fechaDesde="+fechaDesde+"&fechaHasta="+fechaHasta,"",especificaciones);
		}else{
			window.open("../../reportesCertificadoOrigen.do?metodo=generarReporteCertificadosOrigenPorProductorEntreFechas&productor="+productor+"&fechaDesde="+fechaDesde+"&fechaHasta="+fechaHasta,"",especificaciones);
		}
	}
		...
		var textoError2 = (fechaDesde == "")?"* Fecha Desde es un dato obligatorio<br>":"";
		var textoError3 = (fechaHasta == "")?"* Fecha Hasta es un dato obligatorio":"";
...
<table border="0" class="cuadrado" align="center" width="70%" cellpadding="2">
	<tr>
		<td class="azulAjustado">
			Certificados de Origen por Productor Entre Fechas
		</td>
	</tr>
	<tr>
		<td height="20"></td>
