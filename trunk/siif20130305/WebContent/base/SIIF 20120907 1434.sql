...
CREATE TABLE `guiaforestal` (
  ...
  `fiscalizacion_fk` bigint(20) DEFAULT NULL,
  `usuario_fk` bigint(20) DEFAULT NULL,
  `cantidadMts` double DEFAULT NULL,
  ...
  KEY `FKAE8BBDCEC88B2F9` (`tipoProducto_fk`),
  ...
  CONSTRAINT `FKAE8BBDCEC88B2F9` FOREIGN KEY (`tipoProducto_fk`) REFERENCES `tipoproducto` (`id`),
...
INSERT INTO `guiaforestal` VALUES (1,100,50,0,'Lenga','Verde','2010-12-08 00:00:00','2011-01-02 00:00:00',6500,1300,'Rio Grande',21010,'','65.0',1,NULL,100,55,'2010-2011',1,3),(2,0,0,5,'Lenga','Seco','2011-03-11 00:00:00','2011-10-06 00:00:00',100000,20000,'Rio Grande',51298,'sdfsdflaskdjslakdjsalkdjsaldkjasldkjaslkdjsaldkjsalkdjsalkdjaslkdjaslkdjalskdjslakdjaslkdjaslkdjas\r\nsdfsdfsd\r\nsdfsdfsd\r\nsdfsdf\r\nsdfsdf','100.0',4,NULL,1000,110,'2011-2012',4,2),(3,0,0,0,'Lenga','Seco','2011-06-15 00:00:00','2011-10-21 00:00:00',200000,40000,'Rio Grande',45897,'','100.0',3,NULL,2000,110,'2012-2013',4,2),(5,0,0,0,'Lenga','Seco','2012-01-13 00:00:00','2012-04-17 00:00:00',15000,3000,'Rio Grande',8978255,'qwe\r\nqwe\r\nqwe\r\nqwe\r\nqwe\r\nqwe','15.0',6,NULL,1000,110,'2012-2013',3,3),(7,0,0,10,'Lenga','Seco','2012-08-31 00:00:00','2012-12-31 00:00:00',75000,15000,'Rio Grande',555555,'asd\r\nasd\r\nasd','50.0',14,3,1500,100,'2012-2013',2,4),(8,0,0,10,'Lenga','Verde','2012-09-07 00:00:00','2013-04-01 00:00:00',65000,13000,'Rio Grande',888888,'asd\r\nasd\r\nasd','65.0',NULL,3,1000,100,'2012-2013',1,3),(9,0,0,20,'Lenga','Seco','2012-09-08 00:00:00','2013-03-25 00:00:00',28000,5600,'Rio Grande',999999,'','70.0',NULL,3,400,10,'2012-2013',2,3);
...
-- Dump completed on 2012-09-07 15:42:01
